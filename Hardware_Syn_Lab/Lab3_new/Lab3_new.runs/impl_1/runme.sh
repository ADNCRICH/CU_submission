...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/Lab3_new/Lab3_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourCounter.tcl -notrace
