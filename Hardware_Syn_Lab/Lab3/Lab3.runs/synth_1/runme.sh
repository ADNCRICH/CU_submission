...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log problem3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source problem3.tcl
