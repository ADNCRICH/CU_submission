...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log problem3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source problem3.tcl -notrace
