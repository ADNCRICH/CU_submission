...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HexToSeven.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HexToSeven.tcl
