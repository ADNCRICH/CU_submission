...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HexToSeven.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HexToSeven.tcl -notrace
