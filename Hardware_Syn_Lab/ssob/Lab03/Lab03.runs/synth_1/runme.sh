...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab03/Lab03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentTDM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegmentTDM.tcl
