...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab02/Lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentTDM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegmentTDM.tcl -notrace
