...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Binary2BCDDisplayer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary2BCDDisplayer.tcl -notrace
