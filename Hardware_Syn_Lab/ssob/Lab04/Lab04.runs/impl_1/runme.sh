...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StackDisplayer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StackDisplayer.tcl -notrace
