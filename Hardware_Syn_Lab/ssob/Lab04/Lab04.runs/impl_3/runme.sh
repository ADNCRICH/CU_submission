...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/ssob/Lab04/Lab04.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log CalculatorDisplayer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CalculatorDisplayer.tcl -notrace
