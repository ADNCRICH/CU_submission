...
namespace eval ::optrace {
  variable script "D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.runs/synth_2/Binary2BCDDisplayer.tcl"
...
read_verilog -library xil_defaultlib {
  ...
  D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.srcs/sources_1/new/Binary2BCDDisplayer.v
}
...
synth_design -top Binary2BCDDisplayer -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Binary2BCDDisplayer.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_2_synth_report_utilization_0" "report_utilization -file Binary2BCDDisplayer_utilization_synth.rpt -pb Binary2BCDDisplayer_utilization_synth.pb"
