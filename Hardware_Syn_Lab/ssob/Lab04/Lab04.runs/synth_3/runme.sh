...
HD_PWD='D:/AD/CU_submission/Hardware_Syn_Lab/ssob/Lab04/Lab04.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log CalculatorDisplayer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CalculatorDisplayer.tcl
