...
HD_PWD='D:/Code/CU/HW_Syn_Lab/Lab04/Lab04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StackDisplayer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StackDisplayer.tcl
